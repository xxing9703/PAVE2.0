...
P{1}=[on{1},off{2},off{3},off{4}];
P{2}=[off{1},on{2},off{3},off{4}];
P{3}=[off{1},off{2},on{3},off{4}];
P{4}=[off{1},off{2},off{3},on{4}];
P{5}=[on{1},on{2},off{3},off{4}];
P{6}=[off{1},off{2},on{3},on{4}];
